...
(function (factory, window) {
  ...
  L.Map.addInitHook(function () {
      ...
      this.timeDimension = L.timeDimension(this.options.timeDimensionOptions || {});
      // console.log(this.timeDimension, this.options.timeDimension, L.timeDimension(this.options.timeDimensionOptions || {}));
  });
  ...
  L.TimeDimension.Layer = (L.Layer || L.Class).extend({
      ...
      initialize: function(layer, options) {
          ...
          console.log(this._timeDimension, this.options.timeDimension);
      },
