L.Control.ZoomBar = L.Control.extend({
  ...
  options: {
    ...
    zoomInIconClass: 'tnw-plus zoom',
    zoomOutIconClass: 'tnw-minus zoom',
  ...
  onAdd: function (map) {
    ...
    var container_ul = L.DomUtil.create('ul', 'map-control-container',container);
    this._map = map;
  ...
  _zoomToAreaEnable: function () {
    ...
    L.DomUtil.addClass(this._zoomToBBoxButton,'active');
  ...
  _zoomToAreaDisable: function () {
    ...
    L.DomUtil.removeClass(this._zoomToBBoxButton,'active');
